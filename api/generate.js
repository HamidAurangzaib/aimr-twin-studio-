...
export default async function handler(req, res) {
  ...
  const locationDirectives = {
    "CEO Studio Business Shot":
      "Luxury CEO studio portrait. Confident female entrepreneur standing in a professional photography studio. Tailored blush-pink power suit with elegant styling. Arms crossed confidently. Premium personal brand aesthetic. Clean neutral studio backdrop in warm beige tones. Soft high-end beauty lighting with subtle shadows and depth. Executive presence. Forbes magazine style photography. Powerful businesswoman energy. Wealthy founder aesthetic. Perfect posture. Looking directly into camera with confidence and authority. Luxury branding photoshoot. Professional LinkedIn profile quality. Corporate magazine cover standard. Sharp facial details. Natural skin texture. Visible pores. Realistic makeup. High-end commercial photography. DSLR 85mm lens. Shallow depth of field. Ultra realistic. Premium entrepreneur branding image suitable for websites, speaker pages, investor decks, social media, podcasts, books, and press features. Captured in cinematic RAW DSLR format. No filters. Visible skin texture. Balanced warm lighting for natural tone and depth.",
  };
